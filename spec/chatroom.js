        ...
        describe("A Chat Room", function () {
            ...
            it("can be configured if you're its owner",
                ...
                test_utils.waitUntil(function () {
                    ...
                    expect($(view.el.querySelector('form.chatroom-form fieldset')).length).toBe(2);
        ...
        describe("Each chat room can take special commands", function () {
            ...
            it("/topic to set the room topic",
                ...
                test_utils.openAndEnterChatRoom(_converse, 'lounge', 'localhost', 'dummy').then(function () {
                    ...
                    var textarea = view.el.querySelector('.chat-textarea');
                    textarea.textContent = '/topic This is the room subject';
                    view.keyPressed({
                        target: textarea,
                        preventDefault: _.noop,
                        keyCode: 13
            ...
            it("/clear to clear messages",
                ...
                test_utils.openAndEnterChatRoom(_converse, 'lounge', 'localhost', 'dummy').then(function () {
                    ...
                    spyOn(view, 'onMessageSubmitted').and.callThrough();
                    spyOn(view, 'clearChatRoomMessages');
                    var textarea = view.el.querySelectorAll('.chat-textarea')
